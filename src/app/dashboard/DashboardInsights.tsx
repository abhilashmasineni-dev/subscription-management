...
import { TrendingUp, Coins, BarChart3, Zap, ArrowUpRight, ArrowDownRight, LayoutDashboard, Lightbulb } from 'lucide-react'
...
export function DashboardInsights({ subscriptions }: Props) {
  ...
  return (
    <div className="rounded-[2rem] border border-border bg-card p-6 shadow-sm overflow-hidden">
