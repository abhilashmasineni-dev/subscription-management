            ...
            <div className="relative w-full max-w-2xl overflow-hidden rounded-3xl border border-border/70 bg-card shadow-2xl animate-in zoom-in-95 duration-200">
              <div className="flex items-center justify-between border-b border-border/80 px-6 py-5">
                <div>
                  ...
                  <p className="mt-1 text-sm text-secondary">Update details and billing information for this service.</p>
                </div>
                <button
                    ...
                    <div>
                      ...
                      <div className="relative mt-1">
                        ...
                        <input
                          ...
                          placeholder="0.00"
                          className="block w-full rounded-lg border border-border bg-background py-2 pl-7 pr-3 text-foreground focus:border-primary focus:ring-1 focus:ring-primary"
                        />
                      </div>
                    </div>
